...
class Transaksi_model extends CI_Model
{
    ...
    function json() {
        ...
        //$this->datatables->join('table2', 'transaksi.field = table2.field');
         $this->datatables->add_column('action', anchor(site_url('transaksi/update/$1'),'<i class="fa fa-pencil"></i>','class="btn btn-info"')." | ".anchor(site_url('transaksi/delete/$1'),'<i class="fa fa-trash"></i>','class="btn btn-danger"','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id');
        return $this->datatables->generate();
    }

    function get_by_transaksi($transaksi)
    {
        $this->db->select('detail_transaksi.id,produk.nama,harga,jumlah,gambar,berat,id_provinsi,id_kota');
